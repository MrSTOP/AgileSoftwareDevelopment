                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach var="systemUserInfo" items="${requestScope.systemUserAllInfoList}">
                                <tr class="gradeX">
                                    <td>${systemUserInfo.uid}</td>
                                    <td>${systemUserInfo.userInfoTrueName}</td>
                                    <td>${systemUserInfo.userInfoTel}</td>
                                    <td class="center">${systemUserInfo.userInfoSex}</td>
                                    <td class="center">${systemUserInfo.userName}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                            <!--数据体 结束-->
