                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <c:forEach var="businessInfo" items="${requestScope.businessInfoList}">
                                <tr class="gradeX">
                                    <td>${businessInfo.businessInfoId}</td>
                                    <td>${businessInfo.businessInfoName}</td>
                                    <td>${businessInfo.businessInfoLegalPerson}</td>
                                    <td class="center">${businessInfo.businessInfoLegalPersonTel}</td>
